        ...
        <hr className='w-48 h-1 mx-auto my-10 bg-orangeveg mb-32'></hr>
            ...
            <section className='mb-48 h-96 bg-greenveg grid place-content-center'>
                <div className='w-9/12 mx-auto md:max-w-full md:flex'>
                    ...
                    <div className='bg-white -mt-10 border-2 border-greenveg place-self-center p-4 grid place-content-center md:h-full md:border-0 md:m-0'>
                        <div className='mb-8'>
                            <div className='text-center font-questrial'>
            ...
            <div className='w-36 relative rounded overflow-hidden md:w-72'>
                ...
                <h1 className='absolute p-1 inset-x-0 bottom-4 bg-greenveg text-white font-questrial text-sm text-center md:text-xl'>
                    Ingredientes mas frescos</h1>
            </div>
            <div className='w-36 relative rounded overflow-hidden md:w-72'>
                <img src={jugo} alt='mascota' />
                <h1 className='absolute p-1 inset-x-0 bottom-4 text-white font-questrial bg-greenveg text-sm text-center md:text-xl'>
                    Probá nuestros jugos naturales</h1>
            </div>
            <div className='w-36 relative rounded overflow-hidden md:w-72'>
                <img src={pet} alt='mascota' />
                <h1 className='absolute p-1 inset-x-0 bg-greenveg bottom-4 text-white text-sm font-questrial text-center md:text-xl'>
